...
const Sidebar = () => {
  return (
    <aside className="w-full min-h-screen border-r border-border">
      <NavLink to="/">
      ...
      <nav className="flex-1 p-4 space-y-2">
        <SidebarLink to="/continente" icon="fa-earth-americas" label="Continentes" />
        <SidebarLink to="/pais" icon="fa-flag-usa" label="Países" />
        <SidebarLink to="/cidade" icon="fa-city" label="Cidades" />
        <SidebarLink to="/bandeira" icon="fa-flag" label="Bandeiras" />
      </nav>
    </aside>
  );
};
